...
export function FilterToolbar({
  ...
  const activeFilters: ActiveFilter[] = useMemo(() => filterStateToActiveFilters(state), [state]);

  return (
    <div className={`flex flex-wrap items-start gap-compact${className ? ` ${className}` : ''}`}>
      {leading ? (
        <div className="gap-tight flex items-center" data-testid="filter-toolbar-leading">
          {leading}
        </div>
      ) : null}
      ...
      {actions ? (
        <div className="gap-tight flex items-center" data-testid="filter-toolbar-secondary">
          {actions}
        </div>
      ) : null}
      {primary ? (
        <div className="gap-tight flex items-center" data-testid="filter-toolbar-primary">
          {primary}
        </div>
      ) : null}
    </div>
