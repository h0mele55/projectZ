...
function ListPageShellHeader({ children, className }: ListPageShellProps) {
  return <header className={cn('flex-shrink-0', className)}>{children}</header>;
}
...
function ListPageShellBody({ children, className, aside, leftRail }: ListPageShellBodyProps) {
  ...
  if (!aside && !leftRail) {
    return (
      <div
        className={cn('md:flex md:min-h-0 md:flex-1 md:flex-col md:overflow-hidden', className)}
  ...
  // table's full height.
  return (
    <div className="gap-section md:flex md:min-h-0 md:flex-1 md:flex-col md:overflow-hidden xl:flex-row">
      {leftRail && (
        <aside
      ...
      <div
        className={cn(
          'md:flex md:min-h-0 md:flex-1 md:flex-col md:overflow-hidden xl:min-w-0',
          className,
        )}
        data-list-page-body="true"
      >
...
function ListPageShellFooter({ children, className }: ListPageShellProps) {
  return <footer className={cn('flex-shrink-0', className)}>{children}</footer>;
}
