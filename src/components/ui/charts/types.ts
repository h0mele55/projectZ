...
import { TooltipWithBounds, type UseTooltipParams, type TooltipInPortalProps } from '@visx/tooltip';
 ...
 */
export interface LabeledSeries<T extends Datum = Datum, V = number> extends Series<T, V> {
  label: string;
}
