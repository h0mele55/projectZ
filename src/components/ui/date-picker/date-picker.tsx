...
export interface DatePickerProps extends ControlledDateValueProps, PickerProps {
  /**
...
export function DatePicker({
  ...
  const displayValue = selected && !Number.isNaN(selected.getTime()) ? formatDate(selected) : null;
            ...
            {clearable && selected && (
              <button
                ...
                className={cn(
                  ...
                  'border-border-subtle border-t px-3 py-2 text-xs',
