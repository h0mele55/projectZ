...
export function Skeleton({ className = '' }: SkeletonProps) {
  return (
    <div
      className={cn(
        'bg-bg-subtle relative overflow-hidden rounded',
        ...
        'motion-reduce:after:translate-x-0 motion-reduce:after:animate-none',
        className,
      )}
      aria-hidden="true"
    />
...
export function SkeletonTable({
  ...
  return (
    <div
      className={cn(
        'bg-bg-default border-border-subtle overflow-hidden rounded-lg border',
        className,
      )}
      aria-hidden="true"
      data-skeleton-table
    >
      <table className="w-full">
        <thead className="border-border-default/50 border-b">
          <tr>
...
export function SkeletonDataTable({ rows = 8, cols = 8 }: { rows?: number; cols?: number }) {
  ...
  return (
    <div className="bg-bg-default border-border-subtle overflow-hidden rounded-lg border">
...
export function SkeletonKpiGrid({ count = 4 }: { count?: number }) {
  return (
    <div
      className={`grid grid-cols-2 ${count === 6 ? 'md:grid-cols-3 lg:grid-cols-6' : 'md:grid-cols-4'} gap-default`}
    >
    ...
    <div className="space-y-section animate-fadeIn" aria-busy="true" aria-label="Loading dashboard">
        ...
        <Card className="space-y-compact">
          ...
          <div className="space-y-tight">
            {Array.from({ length: 3 }).map((_, i) => (
              <div key={i} className="gap-tight flex items-center">
      ...
      <div className="gap-default grid grid-cols-1 lg:grid-cols-2">
        <Card className="space-y-compact">
          ...
          <div className="gap-tight grid grid-cols-2">
        ...
        <Card className="space-y-compact">
          ...
          <div className="space-y-tight">
            {Array.from({ length: 4 }).map((_, i) => (
              <div key={i} className="gap-tight flex items-start">
  ...
  return (
    <div className="space-y-section animate-fadeIn" aria-busy="true" aria-label="Loading details">
      ...
      <div className="space-y-tight">
        ...
        <div className="gap-tight mt-1 flex">
          <SkeletonPill />
      ...
      {/* Tab bar */}
      <div className="border-border-subtle flex gap-1 border-b pb-0.5">
      ...
      {Array.from({ length: 3 }).map((_, i) => (
        <div key={i} className={cn(cardVariants(), 'space-y-default')}>
          ...
          <div className="space-y-compact">
            <div className="gap-default flex items-center">
