...
import { getPageRange, getPaginationState, type PaginationMeta } from './pagination-utils';
  ...
  return (
    <div
      className={cn(
        ...
        'before:from-bg-default before:pointer-events-none before:absolute before:right-0 before:bottom-full before:left-0 before:h-6 before:bg-gradient-to-t before:to-transparent',
    ...
    >
      ...
      <div>
        ...
        >
          {range.total.toLocaleString()} {resourceName?.(range.total !== 1) ?? t('table.items')}
        </As>
      </div>
