...
export const unauthorized = (message: string = 'Unauthorized') => new UnauthorizedError(message);

export const forbidden = (message: string = 'Forbidden') => new ForbiddenError(message);

export const notFound = (message: string = 'Not Found') => new NotFoundError(message);

export const conflict = (message: string = 'Conflict') => new ConflictError(message);

export const rateLimited = (message: string = 'Too many requests') => new RateLimitedError(message);

export const gone = (message: string = 'Gone') => new GoneError(message);

export const internal = (message: string = 'Internal Server Error') => new InternalError(message);
...
export function toApiErrorResponse(
  ...
  if (
    ...
    'testExpose' in error &&
    (error as Error & { testExpose?: unknown }).testExpose
  ) {
