  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        'nav-band-starburst': {
          '0%': {
            'box-shadow': '0 0 6px var(--brand-secondary-default)',
          },
          '30%': {
            'box-shadow': '0 0 24px 4px var(--brand-secondary-default)',
          },
          '100%': {
            'box-shadow': '0 0 6px var(--brand-secondary-default)',
          },
      ...
      animation: {
        ...
        'nav-band-halo-breath': 'nav-band-halo-breath 6s ease-in-out infinite',
        ...
        'nav-band-reveal-sweep': 'nav-band-reveal-sweep 450ms ease-out',
        ...
        // breath, not a snap.
        'nav-band-starburst': 'nav-band-starburst 700ms ease-out',
